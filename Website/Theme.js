...
function setDiscordTheme() {
    root.style.setProperty("--titleColor", "#5a65ea");
    root.style.setProperty("--gridColor", "#565861");
    root.style.setProperty("--backgroundColor", "#313338");
    root.style.setProperty("--textColor", "#dcdee3");
}

function setSerikaDarkTheme() {
    root.style.setProperty("--titleColor", "#e2b714");
...
function setCarbonTheme() {
    root.style.setProperty("--titleColor", "#f66e0d");
    root.style.setProperty("--gridColor", "#616161");
    root.style.setProperty("--backgroundColor", "#313131");
    root.style.setProperty("--textColor", "#f5e6c8");
}

function setFutureFunkTheme() {
    root.style.setProperty("--titleColor", "#f7f2ea");
...
function setMintTheme() {
    root.style.setProperty("--titleColor", "#5cdb95");
    root.style.setProperty("--gridColor", "#20688a");
    root.style.setProperty("--backgroundColor", "#05385b");
    root.style.setProperty("--textColor", "#edf5e1");
}

function setSonokaiTheme() {
...
function setLaserTheme() {
    root.style.setProperty("--titleColor", "#009eaf");
    root.style.setProperty("--gridColor", "#b82356");
    root.style.setProperty("--backgroundColor", "#221b44");
    root.style.setProperty("--textColor", "#dbe7e8");
}

function setViridiscentTheme() {
...
function setMaterialTheme() {
    root.style.setProperty("--titleColor", "#80cbc4");
    root.style.setProperty("--gridColor", "#4c6772");
    root.style.setProperty("--backgroundColor", "#263238");
    root.style.setProperty("--textColor", "#e6edf3");
}

function setModernDolchTheme() {
    root.style.setProperty("--titleColor", "#7eddd3");
    root.style.setProperty("--gridColor", "#54585c");
    root.style.setProperty("--backgroundColor", "#2d2e30");
    root.style.setProperty("--textColor", "#e3e6eb");
}

function setSuperuserTheme() {
    root.style.setProperty("--titleColor", "#43ffaf");
    root.style.setProperty("--gridColor", "#526777");
    root.style.setProperty("--backgroundColor", "#262a33");
    root.style.setProperty("--textColor", "#e5f7ef");
}

function setRudyTheme() {
    root.style.setProperty("--titleColor", "#af8f5c");
    root.style.setProperty("--gridColor", "#3a506c");
    root.style.setProperty("--backgroundColor", "#1a2b3e");
    root.style.setProperty("--textColor", "#c9c8bf");
}

function setBushidoTheme() {
    root.style.setProperty("--titleColor", "#ec4c56");
    root.style.setProperty("--gridColor", "#596172");
    root.style.setProperty("--backgroundColor", "#242933");
    root.style.setProperty("--textColor", "#f6f0e9");
}

function setMashuTheme() {
...
function setBouquetTheme() {
    root.style.setProperty("--titleColor", "#eaa09c");
    root.style.setProperty("--gridColor", "#408e7b");
    root.style.setProperty("--backgroundColor", "#173f35");
    root.style.setProperty("--textColor", "#e9e0d2");
}

function setNebulaTheme() {
...
function setPeachBlossomTheme() {
    root.style.setProperty("--titleColor", "#99b898");
    root.style.setProperty("--gridColor", "#616161");
    root.style.setProperty("--backgroundColor", "#292929");
    root.style.setProperty("--textColor", "#fecea8");
}

function set80sAfterDarkTheme() {
    root.style.setProperty("--titleColor", "#fca6d1");
    root.style.setProperty("--gridColor", "#99d6ea");
    root.style.setProperty("--backgroundColor", "#1b1d36");
    root.style.setProperty("--textColor", "#e1e7ec");
}

function setGithubTheme() {
    root.style.setProperty("--titleColor", "#41ce5c");
    root.style.setProperty("--gridColor", "#788386");
    root.style.setProperty("--backgroundColor", "#212830");
    root.style.setProperty("--textColor", "#ccdae6");
}

function setLunaTheme() {
    root.style.setProperty("--titleColor", "#f67599");
    root.style.setProperty("--gridColor", "#5a3a7e");
    root.style.setProperty("--backgroundColor", "#221c35");
    root.style.setProperty("--textColor", "#ffe3eb");
}

function setBlueDolphinTheme() {
    root.style.setProperty("--titleColor", "#ffcefb");
    root.style.setProperty("--gridColor", "#00e4ff");
    root.style.setProperty("--backgroundColor", "#003950");
    root.style.setProperty("--textColor", "#82eaff");
}

function setGruvboxDarkTheme() {
    root.style.setProperty("--titleColor", "#d79921");
    root.style.setProperty("--gridColor", "#665c54");
    root.style.setProperty("--backgroundColor", "#282828");
    root.style.setProperty("--textColor", "#ebdbb2");
}

function setPurpleishTheme() {
    root.style.setProperty("--titleColor", "#7a52cc");
    root.style.setProperty("--gridColor", "#5c5c99");
    root.style.setProperty("--backgroundColor", "#1e1e32");
    root.style.setProperty("--textColor", "#a3a3cc");
}

function setBlissTheme() {
    root.style.setProperty("--titleColor", "#f0d3c9");
    root.style.setProperty("--gridColor", "#665957");
    root.style.setProperty("--backgroundColor", "#262727");
    root.style.setProperty("--textColor", "#fff");
}

function setCatppuccinTheme() {
    root.style.setProperty("--titleColor", "#cba6f7");
    root.style.setProperty("--gridColor", "#7f849c");
    root.style.setProperty("--backgroundColor", "#1e1e2e");
    root.style.setProperty("--textColor", "#cdd6f4");
}

function setWavezTheme() {
    root.style.setProperty("--titleColor", "#6bde3b");
    root.style.setProperty("--gridColor", "#1f5e6b");
    root.style.setProperty("--backgroundColor", "#1c292f");
    root.style.setProperty("--textColor", "#e9efe6");
}
...
function setNautilusTheme() {
    root.style.setProperty("--titleColor", "#ebb723");
    root.style.setProperty("--gridColor", "#0b4c6c");
    root.style.setProperty("--backgroundColor", "#132237");
    root.style.setProperty("--textColor", "#1cbaac");
}

function setNorseTheme() {
    root.style.setProperty("--titleColor", "#2b5f6d");
    root.style.setProperty("--gridColor", "#505b5e");
    root.style.setProperty("--backgroundColor", "#242425");
    root.style.setProperty("--textColor", "#ccc2b1");
}

function setMetaverseTheme() {
    root.style.setProperty("--titleColor", "#d82934");
    root.style.setProperty("--gridColor", "#5e5e5e");
    root.style.setProperty("--backgroundColor", "#232323");
    root.style.setProperty("--textColor", "#e8e8e8");
}

function setRosePineTheme() {
    root.style.setProperty("--titleColor", "#9ccfd8");
    root.style.setProperty("--gridColor", "#c4a7e7");
    root.style.setProperty("--backgroundColor", "#1f1d27");
    root.style.setProperty("--textColor", "#e0def4");
}

function setDevTheme() {
    root.style.setProperty("--titleColor", "#23a9d5");
    root.style.setProperty("--gridColor", "#4b5975");
    root.style.setProperty("--backgroundColor", "#1b2028");
    root.style.setProperty("--textColor", "#ccccb5");
}

function setHorizonTheme() {
...
function setSunsetTheme() {
    root.style.setProperty("--titleColor", "#f79777");
    root.style.setProperty("--gridColor", "#5b578e");
    root.style.setProperty("--backgroundColor", "#211e24");
    root.style.setProperty("--textColor", "#f4e0c9");
}

function setMoonlightTheme() {
    root.style.setProperty("--titleColor", "#c69f68");
    root.style.setProperty("--gridColor", "#4b5975");
    root.style.setProperty("--backgroundColor", "#191f28");
    root.style.setProperty("--textColor", "#ccccb5");
}

function setIshtarTheme() {
    root.style.setProperty("--titleColor", "#91170c");
    root.style.setProperty("--gridColor", "#847869");
    root.style.setProperty("--backgroundColor", "#202020");
    root.style.setProperty("--textColor", "#fae1c3");
}

function setDarkNoteTheme() {
    root.style.setProperty("--titleColor", "#f2c17b");
    root.style.setProperty("--gridColor", "#768f95");
    root.style.setProperty("--backgroundColor", "#1f1f1f");
    root.style.setProperty("--textColor", "#d2dff4");
}

function setDrowningTheme() {
    root.style.setProperty("--titleColor", "#4a6fb5");
    root.style.setProperty("--gridColor", "#50688c");
    root.style.setProperty("--backgroundColor", "#191826");
    root.style.setProperty("--textColor", "#9393a7");
}

function setGrapeTheme() {
    root.style.setProperty("--titleColor", "#ff8f00");
    root.style.setProperty("--gridColor", "#6e225e");
    root.style.setProperty("--backgroundColor", "#2c003e");
    root.style.setProperty("--textColor", "#fff");
}

function setVSCodeTheme() {
    root.style.setProperty("--titleColor", "#007acc");
    root.style.setProperty("--gridColor", "#4d4d4d");
    root.style.setProperty("--backgroundColor", "#1e1e1e");
    root.style.setProperty("--textColor", "#d4d4d4");
}

function setMetropolisTheme() {
    root.style.setProperty("--titleColor", "#56c3b7");
    root.style.setProperty("--gridColor", "#326984");
    root.style.setProperty("--backgroundColor", "#0f1f2c");
    root.style.setProperty("--textColor", "#e4edf1");
}

function setAlduinTheme() {
    root.style.setProperty("--titleColor", "#dfd7af");
    root.style.setProperty("--gridColor", "#444444");
    root.style.setProperty("--backgroundColor", "#1c1c1c");
    root.style.setProperty("--textColor", "#f5f3ed");
}

function setOliviaTheme() {
    root.style.setProperty("--titleColor", "#deaf9d");
    root.style.setProperty("--gridColor", "#4e3e3e");
    root.style.setProperty("--backgroundColor", "#1c1b1d");
    root.style.setProperty("--textColor", "#f2efed");
}

function setIcebergDarkTheme() {
    root.style.setProperty("--titleColor", "#84a0c6");
    root.style.setProperty("--gridColor", "#595e76");
    root.style.setProperty("--backgroundColor", "#161821");
    root.style.setProperty("--textColor", "#c6c8d1");
}

function setSolarizedDarkTheme() {
    root.style.setProperty("--titleColor", "#859900");
    root.style.setProperty("--gridColor", "#2aa198");
    root.style.setProperty("--backgroundColor", "#002b36");
    root.style.setProperty("--textColor", "#268bd2");
}

function setDarkMagicGirlTheme() {
    root.style.setProperty("--titleColor", "#f5b1cc");
    root.style.setProperty("--gridColor", "#93e8d3");
...
function setCyberspaceTheme() {
    root.style.setProperty("--titleColor", "#00ce7c");
    root.style.setProperty("--gridColor", "#9578d3");
    root.style.setProperty("--backgroundColor", "#181c18");
    root.style.setProperty("--textColor", "#c2fbe1");
}

function setTerminalTheme() {
    root.style.setProperty("--titleColor", "#79a617");
    root.style.setProperty("--gridColor", "#48494b");
    root.style.setProperty("--backgroundColor", "#191a1b");
    root.style.setProperty("--textColor", "#e7eae0");
}

function setChaosTheoryTheme() {
    root.style.setProperty("--titleColor", "#fd77d7");
    root.style.setProperty("--gridColor", "#676e8a");
    root.style.setProperty("--backgroundColor", "#141221");
    root.style.setProperty("--textColor", "#dde5ed");
}

function setJokerTheme() {
    root.style.setProperty("--titleColor", "#99de1e");
...
function setEverblushTheme() {
    root.style.setProperty("--titleColor", "#8ccf7e");
    root.style.setProperty("--gridColor", "#838887");
    root.style.setProperty("--backgroundColor", "#141b1e");
    root.style.setProperty("--textColor", "#dadada");
}

function setMiamiNightsTheme() {
    root.style.setProperty("--titleColor", "#e4609b");
    root.style.setProperty("--gridColor", "#47bac0");
    root.style.setProperty("--backgroundColor", "#18181a");
    root.style.setProperty("--textColor", "#fff");
}

function setAetherTheme() {
    root.style.setProperty("--titleColor", "#eedaea");
    root.style.setProperty("--gridColor", "#cf6bdd");
    root.style.setProperty("--backgroundColor", "#101820");
    root.style.setProperty("--textColor", "#eedaea");
}

function setPulseTheme() {
    root.style.setProperty("--titleColor", "#17b8bd");
    root.style.setProperty("--gridColor", "#53565a");
    root.style.setProperty("--backgroundColor", "#181818");
    root.style.setProperty("--textColor", "#e5f4f4");
}

function setAntiHeroTheme() {
    root.style.setProperty("--titleColor", "#ffadad");
    root.style.setProperty("--gridColor", "#ff3d8b");
    root.style.setProperty("--backgroundColor", "#00002e");
    root.style.setProperty("--textColor", "#f1deef");
}

function setRyujinscalesTheme() {
    root.style.setProperty("--titleColor", "#f17754");
    root.style.setProperty("--gridColor", "#ffbc90");
    root.style.setProperty("--backgroundColor", "#081426");
    root.style.setProperty("--textColor", "#ffe4bc");
}

function setFloretTheme() {
    root.style.setProperty("--titleColor", "#ffdd6d");
    root.style.setProperty("--gridColor", "#779097");
    root.style.setProperty("--backgroundColor", "#00272c");
    root.style.setProperty("--textColor", "#e5e5e5");
}

function setTerrorBelowTheme() {
    root.style.setProperty("--titleColor", "#66ac92");
    root.style.setProperty("--gridColor", "#015c53");
    root.style.setProperty("--backgroundColor", "#0b1e1a");
    root.style.setProperty("--textColor", "#dceae5");
}

function setTronOrangeTheme() {
    root.style.setProperty("--titleColor", "#f0e800");
    root.style.setProperty("--gridColor", "#ff6600");
    root.style.setProperty("--backgroundColor", "#0d1c1c");
    root.style.setProperty("--textColor", "#ffffff");
}

function setAuroraTheme() {
    root.style.setProperty("--titleColor", "#00e980");
    root.style.setProperty("--gridColor", "#245c69");
    root.style.setProperty("--backgroundColor", "#011926");
    root.style.setProperty("--textColor", "#fff");
}

function setSpidermanTheme() {
    root.style.setProperty("--titleColor", "#e23636");
    root.style.setProperty("--gridColor", "#0476f2");
    root.style.setProperty("--backgroundColor", "#0d1219");
    root.style.setProperty("--textColor", "#f0f0f0");
}

function setRedDragonTheme() {
    root.style.setProperty("--titleColor", "#ff3a32");
    root.style.setProperty("--gridColor", "#e2a528");
    root.style.setProperty("--backgroundColor", "#1a0b0c");
    root.style.setProperty("--textColor", "#4a4d4e");
}

function setDarkTheme() {
    root.style.setProperty("--titleColor", "#eee");
    root.style.setProperty("--gridColor", "#444");
    root.style.setProperty("--backgroundColor", "#111");
    root.style.setProperty("--textColor", "#eee");
}
...
function setVesperTheme() {
    root.style.setProperty("--titleColor", "#ffc799");
    root.style.setProperty("--gridColor", "#a0a0a0");
    root.style.setProperty("--backgroundColor", "#101010");
    root.style.setProperty("--textColor", "#ffffff");
}

function setVocTheme() {
    root.style.setProperty("--titleColor", "#e0caac");
    root.style.setProperty("--gridColor", "#4c1e48");
    root.style.setProperty("--backgroundColor", "#190618");
    root.style.setProperty("--textColor", "#eeeae4");
}

function setMidnightTheme() {
    root.style.setProperty("--titleColor", "#60759f");
    root.style.setProperty("--gridColor", "#394760");
    root.style.setProperty("--backgroundColor", "#0b0e13");
    root.style.setProperty("--textColor", "#9fadc6");
}

function setMountainTheme() {
    root.style.setProperty("--titleColor", "#e7e7e7");
    root.style.setProperty("--gridColor", "#4c4c4c");
    root.style.setProperty("--backgroundColor", "#0f0f0f");
    root.style.setProperty("--textColor", "#e7e7e7");
}

function setArchTheme() {
    root.style.setProperty("--titleColor", "#7ebab5");
    root.style.setProperty("--gridColor", "#454864");
    root.style.setProperty("--backgroundColor", "#0c0d11");
...
function setTerraTheme() {
    ...
    root.style.setProperty("--backgroundColor", "#0c100e");
    root.style.setProperty("--textColor", "#f0edd1");
}

function setTranceTheme() {
    root.style.setProperty("--titleColor", "#e51376");
    root.style.setProperty("--gridColor", "#3c4c79");
    root.style.setProperty("--backgroundColor", "#00021b");
    root.style.setProperty("--textColor", "#fff");
}

function setSolarizedOsakaTheme() {
    root.style.setProperty("--titleColor", "#859900");
    root.style.setProperty("--gridColor", "#2aa198");
    root.style.setProperty("--backgroundColor", "#00141a");
    root.style.setProperty("--textColor", "#eee8d5");
}

function setIvSpadeTheme() {
    root.style.setProperty("--titleColor", "#b7976a");
    root.style.setProperty("--gridColor", "#404040");
    root.style.setProperty("--backgroundColor", "#0c0c0c");
    root.style.setProperty("--textColor", "#d3c2c3");
}

function setHammerheadTheme() {
    root.style.setProperty("--titleColor", "#4fcdb9");
    root.style.setProperty("--gridColor", "#213c53");
    root.style.setProperty("--backgroundColor", "#030613");
    root.style.setProperty("--textColor", "#e2f1f5");
}

function setPhantomTheme() {
    root.style.setProperty("--titleColor", "#7aa2f7");
    root.style.setProperty("--gridColor", "#414868");
    root.style.setProperty("--backgroundColor", "#001");
    root.style.setProperty("--textColor", "#c0caf5");
}

function setFireTheme() {
    root.style.setProperty("--titleColor", "#b31313");
    root.style.setProperty("--gridColor", "#683434");
    root.style.setProperty("--backgroundColor", "#0f0000");
    root.style.setProperty("--textColor", "#ffffff");
}
...
function setHusqyTheme() {
    ...
    root.style.setProperty("--textColor", "#ebd7ff");
}

function setMatrixTheme() {
    root.style.setProperty("--titleColor", "#15ff00");
